...
const About = () => {
  return (
    <div className="relative flex h-full w-full items-center justify-center sm:mt-[15%] md:-mt-[5%] md:h-screen md:justify-end lg:mb-10 lg:mt-[20%]">
      <Image
        src={trafficLight}
        alt="Traffic Light Asset"
        className="absolute left-0 top-5 w-1/3 md:w-3/4 lg:top-28 xl:w-1/2"
      />
