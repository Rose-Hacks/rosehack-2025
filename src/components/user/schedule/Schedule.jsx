      ...
      <div className="sticky top-0 z-10 flex w-full flex-col pt-4">
        ...
        <div className="flex">
          {days.map((day, index) => {
            ...
            return (
              <div
                className="font-montserrat m-5 ml-0 flex flex-grow items-center justify-start border-b-[1px] border-rosehack-white text-sm font-semibold text-rosehack-white md:text-lg"
                key={index}
              >
                {day} -{" "}
